...
func AnomaliesHandler(
	...
	return func(c echo.Context) error {
		...
		anomalies, err := store.FetchAnomaliesByTimeRange(c.Request().Context(), startTS, endTS)
		if err != nil {
			logger.Error("failed to fetch anomalies", zap.Error(err))
